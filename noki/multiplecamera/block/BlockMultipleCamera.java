package noki.multiplecamera.block;
...
public class BlockMultipleCamera extends BlockContainer {
	...
	public TileEntity createNewTileEntity(World world, int metadata) {
		...
		if(MultipleCameraData.ccLoaded) {
			return new PeripheralMultipleCamera();
		}
		else {
			return new TileMultipleCamera();
		}
/*		if(MultipleCameraData.ccLoaded) {
			return new PeripheralMultipleCamera(world, metadata);
		}
		else {
			return new TileMultipleCamera(world, metadata);
		}*/
