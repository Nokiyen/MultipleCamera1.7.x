...
public class ModInfo {
	...
	//*****	
	public static final String ID = "MultipleCamera";
	public static final String NAME = "Multiple Camera";
	public static final String VERSION = "1.0.1";
	public static final String CHANNEL = ID;
	public static final String DEPENDENCY = "after:ComputerCraft";
	
	public static final String PROXY_LOCATION = "noki.multiplecamera.proxy.";
